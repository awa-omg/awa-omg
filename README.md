![header](https://capsule-render.vercel.app/api?type=waving&height=300&color=gradient:7c3aed,ec4899,06b6d4&section=header&reversal=false)

<p align="center">
  <img src="https://github.com/awa-omg.png" alt="avatar" width="130" style="border-radius: 50%; border: 3px solid #7c3aed; box-shadow: 0 0 20px #7c3aed, 0 0 40px #ec4899;" />
</p>

<h1 align="center" style="background: linear-gradient(90deg, #7c3aed, #ec4899, #06b6d4, #f59e0b); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-size: 3em; font-weight: 900; letter-spacing: 3px;">
  AGUITA
</h1>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3500&pause=1200&color=7c3aed&center=true&vCenter=true&width=550&lines=Building+worlds+from+code...;One+commit+at+a+time...;Full+Stack+%7C+ML+Engineer;From+Mexico+to+the+world" alt="typing" />
</p>
...
<table align="center" width="60%">
  <tr>
    <td align="center" style="border: 2px solid #7c3aed; border-radius: 16px; padding: 20px; background: linear-gradient(135deg, rgba(124, 58, 237, 0.08), rgba(236, 72, 153, 0.08));">
      <a href="https://youtu.be/eSW2LVbPThw">
        <img src="Rabbithole.jpg" width="280" style="border-radius: 12px; box-shadow: 0 0 25px #7c3aed, 0 0 50px #ec4899, 0 8px 32px rgba(0,0,0,0.4);" alt="Rabbit Hole" />
      </a>
...
![footer](https://capsule-render.vercel.app/api?type=waving&height=200&color=gradient:7c3aed,ec4899,06b6d4&section=footer&reversal=false)
